// Phase-2 HLS per-kernel testbench: anp_original_forward ONLY.
//
...
//
// Drives anp_original_forward against BOTH Phase-0 golden fixtures
...
// Exercise the original kernel on one fixture.
void run_fixture(const std::string& fixture_subdir) {
    ...
    std::printf("  --- anp_original_forward ---\n");
...
int main() {
    std::printf("Phase-2 HLS per-kernel TB: anp_original_forward vs Phase-0 golden\n");
